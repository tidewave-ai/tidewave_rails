...
class Tidewave::Tools::ListProjectFiles < Tidewave::Tools::Base
  ...
  arguments do
    ...
    optional(:include_ignored).maybe(:boolean).description("Optional: whether to include files that are ignored by .gitignore. Defaults to false. WARNING: Use with targeted glob patterns to avoid listing excessive files from dependencies or build directories.")
  end
